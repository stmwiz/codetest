...
namespace GST_WEBRTC_SEND_RECV{
...
TestGstWebrtcSendRecv::TestGstWebrtcSendRecv(int peer_id):peer_id_(peer_id)
{

}

TestGstWebrtcSendRecv::~TestGstWebrtcSendRecv()
{
    TestImpl::stop();
}

void TestGstWebrtcSendRecv::run()
{
    const int argc = 3;
    char *argv[argc] = {"./tmp","--peer-id",std::to_string(peer_id_).data()};
