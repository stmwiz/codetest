...
namespace TEST_GST_WEBRTC_RECV{
...
TestGstWebrtcRecv::TestGstWebrtcRecv(int peer_id):peer_id_(peer_id)
{

}

TestGstWebrtcRecv::~TestGstWebrtcRecv()
{
    TestImpl::stop();
}

void TestGstWebrtcRecv::run()
{
    const int argc = 1;
    char *argv[argc] = {"./tmp"};
    TEST_GST_WEBRTC_RECV::test_main(argc,argv);
}
